...
{
	header("location:index.php"); //to redirect back to "index.php" 
}
?>
<html lang="en">
<head>
...
<body>
    ...
    <div class="dashboard-main-wrapper">
        ...
        <div class="dashboard-wrapper">
            <div class="dashboard-ecommerce">
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title">Car Rental Statistics</h2>
                    ...
                    <div class="ecommerce-widget">
                        ...
                        <div class="row">
                            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h5 class="text-muted">Total Car</h5>
                                        <div class="metric-value d-inline-block">
										<?php 		
											$str="select * from tlb_car";
											$data=mysqli_query($conn,$str);
											$total_customer=mysqli_num_rows($data);
										?>
												<h1 class="mb-1"><?php echo  $total_customer;?> <i class="fa fa-car"></i></h1>
                                        </div>
										
                                       <!--  <div class="metric-label d-inline-block float-right text-success font-weight-bold">
                                            <span><i class="fa fa-fw fa-user-circle"></i></span><span></span>
                                        </div> -->
                                    </div>
                            ...
                            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h5 class="text-muted">Total Owner</h5>
                                        <div class="metric-value d-inline-block">
                                            <?php 		
											$str="select * from tlb_admin";
											$data=mysqli_query($conn,$str);
											$total_owner=mysqli_num_rows($data);
										?>
												<h1 class="mb-1"><?php echo $total_owner-1;?> <i class="fa fa-fw fa-user"></i></h1>
                            ...
                            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h5 class="text-muted">Number Of Bookings</h5>
                                        <div class="metric-value d-inline-block">
										  <?php 		
											$str="select * from tlb_booking";
											$data=mysqli_query($conn,$str);
											$total_bookings=mysqli_num_rows($data);
										?>
                                            <h1 class="mb-1"><?php echo $total_bookings;?> <i class="fa fa-fw fa-book"></i></h1>
                                        </div>
                            ...
                            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="card">
                                     <div class="card-body">
                                        ...
                                        <div class="metric-value d-inline-block">
										<?php 		
											$str="select * from tlb_user";
											$data=mysqli_query($conn,$str);
											$total_customer=mysqli_num_rows($data);
										?>
												<h1 class="mb-1"><?php echo  $total_customer;?> <i class="fa fa-fw fa-user"></i></h1>
                                        </div>
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                <div class="card border-3 border-top border-top-primary">
                                    <div class="card-body">
                                        <h5 class="text-muted">Number Of Inquiry</h5>
                                        <div class="metric-value d-inline-block">
										<?php 		
											$str="select * from tlb_inqury";
											$data=mysqli_query($conn,$str);
											$total_inquiry=mysqli_num_rows($data);
										?>
                                            <h1 class="mb-1"><?php echo $total_inquiry;?> <i class="fa fa-fw fa-question-circle"></i> </h1>
                                        </div>
                                        <div class="metric-label d-inline-block float-right text-success font-weight-bold">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body p-0">
                                        <div class="table-responsive">
										  <?php
										  $str="select * FROM tlb_booking,tlb_car,tlb_user
													WHERE tlb_booking.car_ID = tlb_car.car_ID and tlb_booking.user_ID = tlb_user.user_ID limit 5 ";
											$data=mysqli_query($conn,$str);
									      ?>
                                            <table class="table">
                                                <thead class="bg-light">
                                                    <tr class="border-0">
														 ...
														 <th class="border-0">Car Name</th>                                                
														 <th class="border-0">Owner Name</th>                                                
														 <th class="border-0">Start Date</th>
														 <th class="border-0">End Date</th>
														 <th class="border-0">Pick Time</th>
														 <th class="border-0">Pick Location</th>
														 <th class="border-0">Destination</th>
														 <th class="border-0">Driver Detail</th>
                                                ...
                                                <tbody>
                                                   <?php
													...
													<tr>
														<td><?php echo $i;?></td>
														<td><?php echo getAllcar_name($row['model_ID']); ?></td>
														<td><?php echo getAllOwner_name($row['car_ID']); ?></td>
														<td><?php echo $row['start_Date'] ?></td>
														<td><?php echo $row['end_Date'] ?></td>
														<td><?php echo $row['pick_Time'] ?></td>
														<td><?php echo $row['pick_Location'] ?></td>
														<td><?php echo $row['destination'] ?></td>
														<td><?php if($row['driver_Status']==1) { echo "With Driver"; } else { echo "Without Driver";} ?></td>
										...
										<button class="btn btn-lg" style="border-radius: 30px;"><a href="viewbooking.php" style="color:black">View Details</a></button></div>
									</div>   
                                    </div>
				...
				<?php
				function getAllcar_name($model_ID)
				{
					global $conn;
					$sql_car="select * from `tlb_model` where model_ID=".$model_ID;
					$result_booking=mysqli_query($conn,$sql_car);
					$data_booking=mysqli_fetch_array($result_booking);
					$a=$data_booking['model_Name'];
					return $a;
				}
				
				
				function getAllOwner_name($car_ID)
				{
					global $conn;
					$sql_car="select * from `tlb_car` where car_ID=".$car_ID;
					$result_booking=mysqli_query($conn,$sql_car);
					$data_booking=mysqli_fetch_array($result_booking);
					$admin_id=$data_booking['admin_ID'];
					$admin_car="select * from `tlb_admin` where admin_ID=".$admin_id;
					$admin_booking=mysqli_query($conn,$admin_car);
					$booking=mysqli_fetch_array($admin_booking);
					return $booking['admin_Name'];
				}
                            ...
                            <div class="col-xl-9 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <h5 class="mb-0"> Monthly Car Booking</h5>
                                    </div>
                                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-5 col-lg-5 col-md-12 col-sm-12 col-12">
                                <div class="card">
                                    <h5 class="card-header">Revenue by Brand</h5>
                                    <div class="card-body">
										<div id="brandrent_container"></div>
	...
	<script>
/*Highcharts.chart('car_container', {
    chart: {
        type: 'cylinder',
        options3d: {
            enabled: true,
...
<script>
	Highcharts.chart('car_container', {
	  ...
	  xAxis: {
				//categories: [<?php while($row14 = mysqli_fetch_array($monthly_fees_student)) { echo "'".date("F", mktime(0, 0, 0, $row14['month'], 10))."',";	} ?>]
				categories: [1,2,3,4,5,6,7,8,9]
			},
	  series: [{
		//data: [<?php while($row15 = mysqli_fetch_array($monthlyfees)) { echo $row15['monthly_fees'].",";	} ?>],
  ...
  <script>
// Build the chart
Highcharts.chart('brandrent_container', {
    chart: {
    ...
    title: {
        text: 'Revenue by Brand -MARCH 2020-21'
    },
    tooltip: {
...
/*Highcharts.chart('brandrent_container', {
  ...
  series: [{
    ...
    colorByPoint: true,
    data: [{
      //name: '<?php echo $direct['reference_Name']?>',
      name: '<?php echo $direct['reference_Name']?>',
      y: <?php echo $direct['number_reference']?>,
      sliced: true,
      selected: true
    }, 
	//<?php while($row = mysqli_fetch_array($reference))  { ?>
	{
      name: '<?php echo $row['reference_Name']?>',
      y: <?php echo $row['number_reference']?>
    }, 
	//<?php  } ?>
	]
  }]
